        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-black">Upload Retinal Fundus Image</h2>
              <Button
                variant="outline"
              ...
              >
                {preview ? (
                  <div className="space-y-4">
                    ...
                    />
                    <p className="text-sm text-black">Click upload to analyze this image or select a different one</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    ...
                    <p className="text-lg font-medium text-black">Upload your retinal fundus image here</p>
                    <p className="text-sm text-black">Accepts medical fundus photographs in JPG, PNG, or JPEG format (max 10MB)</p>
                  </div>
                )}
                <Input
                  type="file"
            ...
            >
              {[
                ...
                },
                {
                  ...
                  description: "Validated against expert diagnoses with over 99% accuracy",
