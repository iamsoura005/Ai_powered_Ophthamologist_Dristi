...
export function Footer() {
  return (
    <footer className="relative mt-20">
      {/* Gradient separator */}
      <div className="h-px bg-gradient-to-r from-transparent via-blue-500/50 to-transparent mb-16" />

      <div className="glass rounded-t-3xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-black border-black">
          ...
          >
            <div className="flex items-center space-x-2 text-gray-400 text-sm">
              <span>© 2024 RetinalAI. Made with</span>
