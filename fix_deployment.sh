...
# Deployment fix script for TensorFlow compatibility issues
# This script updates dependencies and pushes changes to GitHub
...
- Update tensorflow-cpu from 2.13.0 to 2.15.0 for Python 3.11 compatibility
- Update numpy, pillow, scipy to latest compatible versions
...
'Could not find a version that satisfies the requirement tensorflow-cpu==2.13.0'"
...
echo "   - TensorFlow-CPU: 2.13.0 → 2.15.0"
